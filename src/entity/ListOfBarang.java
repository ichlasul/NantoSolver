...
public class ListOfBarang {
	...
	// Getter dan Setter
	public ArrayList<Barang> getListOfbarang() { return this.listOfBarang; }
	public void setListOfBarang(ArrayList<Barang> listOfBarang) { this.listOfBarang = listOfBarang; }

...
public class ListOfCewek {
  ...
  // Konstruktor
  public ListOfCewek() {
    this.listOfCewek = new ArrayList<Cewek>();
    this.jumlahCewek = 0;
  }
  ...
  public void setListOfCewek(final ArrayList<Cewek> listOfCewek) {
    this.listOfCewek = listOfCewek;
  }

  // Add cewek ke list
  public void addCewek(final Cewek cewek) {
    this.listOfCewek.add(cewek);
    this.jumlahCewek++;
  }

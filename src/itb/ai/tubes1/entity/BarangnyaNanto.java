...
public class BarangnyaNanto {
    ...
    // Override
    public BarangnyaNanto(int kuantitasCokelat, int kuantitasBunga,
	    int kuantitasMartabakManis, int kuantitasPermen) {
	...
	return kuantitasCokelat;
    }

    public void setKuantitasCokelat(int kuantitasCokelat) {
	this.kuantitasCokelat = kuantitasCokelat;
    }

    public int getKuantitasBunga() {
	return kuantitasBunga;
    }

    public void setKuantitasBunga(int kuantitasBunga) {
	this.kuantitasBunga = kuantitasBunga;
    }

    public int getKuantitasMartabakManis() {
	return kuantitasMartabakManis;
    }

    public void setKuantitasMartabakManis(int kuantitasMartabakManis) {
	this.kuantitasMartabakManis = kuantitasMartabakManis;
    }

    public int getKuantitasPermen() {
	return kuantitasPermen;
    }

    public void setKuantitasPermen(int kuantitasPermen) {
	this.kuantitasPermen = kuantitasPermen;
    }

    // Operasi terhadap value atribut
    public void addCokelat(int cokelat) {
	this.kuantitasCokelat += cokelat;
    }

    public void addBunga(int bunga) {
	this.kuantitasBunga += bunga;
    }

    public void addMartabakManis(int martabakManis) {
	this.kuantitasMartabakManis += martabakManis;
    }

    public void addPermen(int permen) {
	this.kuantitasPermen += permen;
    }

    public void subCokelat(int cokelat) {
	this.kuantitasCokelat -= cokelat;
    }

    public void subBunga(int bunga) {
	this.kuantitasBunga -= bunga;
    }

    public void subMartabakManis(int martabakManis) {
	this.kuantitasMartabakManis -= martabakManis;
    }

    public void subPermen(int permen) {
	this.kuantitasPermen -= permen;
    }
	...
	switch (X) {
	case "A":
	    return isPunyaCokelat();
	case "B":
	    return isPunyaBunga();
	case "C":
	    return isPunyaMartabakManis();
	case "D":
	    return isPunyaPermen();
	case "-":
	    return true;
	default:
	    return false;
